...
extern "C"{
  ...
  void param_names_R(model_rng** model, int* include_tp, int* include_gq, char const** name_out);
...
void param_names_R(model_rng** model, int* include_tp, int* include_gq, char const** names_out){
